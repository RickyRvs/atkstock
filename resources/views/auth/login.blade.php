...
<head>
    ...
    <title>Login — {{ pengaturan()->nama_sistem }}</title>
...
<body class="bg-animated min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="relative w-full max-w-sm">
        <div class="glass-card rounded-3xl shadow-2xl w-full p-8 border border-white/40">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-xl font-bold text-gray-800">{{ pengaturan()->nama_sistem }}</h1>
           ...
           <p class="text-center text-sm text-gray-500 mt-6">
            ...
            <p class="text-center text-xs text-gray-400 mt-4">
                Sistem Kartu Kendali Barang Persediaan ATK/ARK
            </p>
        </div>
